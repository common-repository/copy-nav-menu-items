 ...
 */
final class Copy_Nav_Menu_Items_Cache extends Copy_Nav_Menu_Items_Wrapper
{
	/**
	...
	protected function _default($name)
	{
		switch ($name)
		{
			...
			case 'manifest':
				...
				return Copy_Nav_Menu_Items_Utilities::load_json('assets/manifest.json');
			...
			case 'plugin_data':
				...
				return Copy_Nav_Menu_Items_Plugins::get_data(plugin_basename($this->base->plugin));
	 ...
	 *
	 * @since 1.1.2 Added additional query args for the filter.
	 * @since 1.0.0
	 *
	 * @access public
	...
	public function get_remove_query_args($query_args = array())
	{
		 ...
		 */
		return apply_filters('ndt_remove_query_args', Copy_Nav_Menu_Items_Utilities::check_array($query_args));
	}
}
