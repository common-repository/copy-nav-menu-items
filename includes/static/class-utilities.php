 ...
 * @since 1.0.0
 */
final class Copy_Nav_Menu_Items_Utilities
{
	/**
	...
	public static function is_field($variable)
	{
		...
		(
			is_object($variable)
			&&
			self::starts_with('Copy_Nav_Menu_Items_Field', get_class($variable))
			&&
			!is_a($variable, 'Copy_Nav_Menu_Items_Field_Tab')
		);
	}
	...
	public static function load_json($file_path, $plugin_path = '')
	{
		...
		{
			$plugin_path = Copy_Nav_Menu_Items()->plugin;
		}
