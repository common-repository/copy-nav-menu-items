...
Simple plugin that allows for nav menu items to be copied with a single click.

== Description ==

Simple plugin that allows for nav menu items to be copied with a single click. Copied nav menu items are added directly after the clicked nav menu item at the same depth. All field values, including custom fields, are duplicated as well.

**[View the Knowledge Base »](https://noakesplugins.com/kb/copy-nav-menu-items/)**
...
3. Search for **Copy Nav Menu Items**
4. Click **Install Now** for the "Copy Nav Menu Items" plugin
5. Click **Activate**
...
5. Go to **Plugins**
6. Click **Activate** under "Copy Nav Menu Items"

= What's Next? =

Once the plugin is active, simply visit **Settings > Copy Nav Menu Items** and enable the settings appropriate for this site.
...
* Fixed: Issue with copied child nav menu items
